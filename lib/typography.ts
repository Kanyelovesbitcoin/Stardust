...
export const TYPE_SCALE = {
    ...
    // Body — Outfit (bumped from regular→medium, light→regular for readability)
    bodyLarge: { fontFamily: FONTS.body.medium, fontSize: 17, lineHeight: 24 },
    body: { fontFamily: FONTS.body.medium, fontSize: 15, lineHeight: 22 },
    bodySmall: { fontFamily: FONTS.body.regular, fontSize: 13, lineHeight: 18 },
    button: { fontFamily: FONTS.body.semiBold, fontSize: 16, lineHeight: 20, letterSpacing: 0.5 },
    label: { fontFamily: FONTS.body.semiBold, fontSize: 12, lineHeight: 16, letterSpacing: 1.2, textTransform: 'uppercase' },

    // Mono — JetBrains (timestamp bumped from 11→12 for min-size)
    stat: { fontFamily: FONTS.mono.regular, fontSize: 28, lineHeight: 34 },
    timestamp: { fontFamily: FONTS.mono.regular, fontSize: 12, lineHeight: 16 },
} as const;
